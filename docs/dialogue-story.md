...
dialogues:
  ...
  - id: ending.empire.result
    speaker: 结果记录
    default: "安静的胜利之后：Alice 放下武器权限，玛拉在广播台读出被注销、被封锁、在冲关与救治中失去的人名。帝国没有立刻崩塌，但再也无法把沉默称作稳定。"
  - id: ending.rebel.intro
    speaker: 船队频道
    default: "解除三道牵引锁，维持难民船完整度。避开民船，余烬狂热派正在试图借它们突击。"
  - id: ending.rebel.result
    speaker: 结果记录
    default: "名字的重量：Bob 的旗舰为广播塔留下盲区，黑匣证据进入公共频段。人们愤怒、恐惧、争吵；广播没有疗伤，却让被注销的人重新拥有名字。"
  - id: ending.deep_rock.intro
    speaker: 工程频道
    default: "守住临时过滤舱，回收三枚过滤核心，并将黑匣证据上传公共广播。"
  - id: ending.deep_rock.result
    speaker: 结果记录
    default: "深岩之下：赵利俄斯外环的广播没有终结战争，但让被注销的人重新拥有名字。工人、医生和工程师仍守着过滤舱；局部隔绝、减毒改造和公开复核都很慢，也都需要继续承担。这里不是完美结局，只是一条没有走开的路。"
  - id: ch03.intro
    speaker: 公共中继频道
    default: "C 区中继站收到净化名单副本。Alice 要求公开，Bob 提醒锈蚀样本真实，Charlie 要求先遮蔽检疫井坐标。"
    pilots:
      alice: "公开名单，但别把检疫井坐标交给下一群冲进去的人。我们得让人看见真相，也得让他们活着。"
      bob: "名单伪造与锈蚀风险可以同时成立。删除任一变量都会制造新的伤亡。"
      charlie: "先把坐标藏掉。真相不是把所有人推向一扇会塌的门。"
  - id: ch03.result
    speaker: 公共中继频道
    default: "第一批名单与航迹已发出。帝国与余烬都开始追踪中继信号，三人再也无法假装只是执行同一份命令。"
  - id: ch04.intro
    speaker: 废弃维修站
    default: "旧实验记录证明锈蚀会沿自修复金属与神经凝胶扩散。Bob 的协处理器再次尝试外发位置包。"
    pilots:
      alice: "切断位置包。没人有资格把我们和维修站里的人一起卖给下一支舰队。"
      bob: "远程链路正在重连。我要回收记录，也要确认这次切断是我自己的选择。"
      charlie: "记录留下，出口也留下。别为了证明一件事，把活人困在这座站里。"
  - id: ch04.result
    speaker: 离线黑匣
    default: "协处理器远程链路已切断。记录没有替任何阵营洗白：帝国把灾难当统治工具，余烬把灾难当火把，病症本身不站队。"
  - id: ch06.intro
    speaker: 船队频道
    default: "冲破封锁后，Alice 拒绝成为余烬的旗帜。Bob 的帝国旗舰正在收紧牵引束，Charlie 则要求民船先撤离。"
    pilots:
      alice: "我不是你们的火种。先解开牵引锁，让船队自己选择往哪里走。"
      bob: "感染增长曲线背后也是人。解除锁定必须同时保留医疗隔离船。"
      charlie: "民船先走。拿平民当盾的人，和把平民锁进门里的人没什么两样。"
  - id: ch06.result
    speaker: 船队频道
    default: "最后一道牵引锁断开。船队带走了名册、医疗记录与仍可能传播锈蚀的幸存者；自由没有抵达终点，只恢复了选择航线的资格。"
  - id: ch07.intro
    speaker: 帝国医疗频道
    default: "永久门已经关闭。Alice 守住医疗缝隙，Bob 从黑市网络带来黑匣副本，Charlie 仍为门后补给争取配额。"
    pilots:
      alice: "守住医疗线，但名单不能继续藏在档案库里。"
      bob: "档案火控链会抹掉名单来源。先断链，再公开审计记录。"
      charlie: "我留在阵线不是因为净化正确，是因为门后的人还需要一条补给缝。"
  - id: ch07.result
    speaker: 帝国档案频道
    default: "火控链失效，黑匣副本被带走。帝国宣布航路恢复，统计屏幕却显示民用通讯存活率归零；安静不是和平的证据。"
  - id: ch08.intro
    speaker: 深岩工程频道
    default: "深岩没有旗帜。工人把报废机甲切成隔离门，医生压低锈蚀反应，工程师请求回收过滤核心并公开复核规则。"
    pilots:
      alice: "先把塌方区的人带进过滤舱。救援不是替他们决定以后该怎么活。"
      bob: "风险必须公开给每一个要拔线或留下的人。系统不能再拥有最终否决。"
      charlie: "先撤离，再交火。这里没有漂亮的胜利，只有别把人留在门后的办法。"
  - id: ch08.result
    speaker: 深岩工程频道
    default: "过滤舱开始运转。局部隔绝会让家庭分开，减毒改造会留下后遗症；深岩拒绝把人分为可以抛弃和不可以抛弃的两类。"
  - id: ch09.rebel.intro
    speaker: 广播塔频道
    default: "赵利俄斯外环，Bob 的帝国旗舰封锁广播塔。关闭旗舰锁定阵列，让黑匣协议向公共频道发送伪造名单与锈蚀实验记录。"
  - id: ch09.empire.intro
    speaker: 深岩运输船
    default: "帝国命令摧毁深岩运输船。Bob 要公开协议，Charlie 切断帝国火控链；先解除火控节点，守住运输船与广播窗口。"
  - id: ch09.deep.intro
    speaker: 广播塔频道
    default: "帝国与余烬都在向广播塔施压。回收最后的广播过滤核心，维持公共塔，把黑匣证据交给每一个将承担后果的人。"
```
